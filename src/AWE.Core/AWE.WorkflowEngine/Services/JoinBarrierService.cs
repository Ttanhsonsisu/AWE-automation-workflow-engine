...
public class JoinBarrierService : IJoinBarrierService
{
    private readonly IDistributedLockProvider _lockProvider;
    private readonly IExecutionPointerRepository _pointerRepo;
    private readonly ILogger<JoinBarrierService> _logger;

    public JoinBarrierService(
        IDistributedLockProvider lockProvider,
        IExecutionPointerRepository pointerRepo,
        ILogger<JoinBarrierService> logger)
    {
