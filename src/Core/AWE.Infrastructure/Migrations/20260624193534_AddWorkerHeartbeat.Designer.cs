...
namespace AWE.Infrastructure.Migrations
{
    ...
    [Migration("20260624193534_AddWorkerHeartbeat")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AWE.Domain.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("AWE.Domain.Entities.WebhookRoute", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("IdempotencyKeyPath")
                        .HasColumnType("text")
                        .HasColumnName("idempotency_key_path");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_webhook_routes");

                    b.HasIndex("RoutePath")
                        .IsUnique()
                        .HasDatabaseName("ix_webhook_routes_route_path");

                    b.ToTable("WebhookRoutes", (string)null);
                });

            modelBuilder.Entity("AWE.Domain.Entities.WorkerHeartbeat", b =>
                {
                    b.Property<string>("WorkerId")
                        .HasMaxLength(160)
                    ...
                    b.HasIndex("WorkerType", "LastSeenAtUtc")
                        .HasDatabaseName("ix_worker_heartbeat_type_last_seen");

                    b.ToTable("WorkerHeartbeat", (string)null);
                });
            ...
            modelBuilder.Entity("AWE.Domain.Entities.WorkflowInstance", b =>
                {
                    ...
                    b.HasIndex("DefinitionId", "IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("ix_workflow_instance_definition_id_idempotency_key")
            ...
            modelBuilder.Entity("AWE.Domain.Entities.WorkflowSchedulerSyncTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_workflow_scheduler_sync_task");

                    b.HasIndex("IsCompleted", "NextAttemptAtUtc")
                        .HasDatabaseName("ix_scheduler_sync_task_due");

                    b.HasIndex("DefinitionId", "Operation", "IsCompleted")
                        .HasDatabaseName("ix_scheduler_sync_task_pending_by_def");

                    b.ToTable("WorkflowSchedulerSyncTask", (string)null);
                });
